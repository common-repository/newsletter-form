    ...
    <div class="col-md-4">
        <div class="btn-group pull-right">
            ...
            <ul class="dropdown-menu" role="menu">
                <li><a href="<?php echo cUsNL_PARTNER_URL; ?>/index.php?loginName=<?php echo $cUs_API_Account; ?>&userPsswd=<?php echo urlencode($cUs_API_Key); ?>&confirmed=1&redir_url=<?php echo urlencode(trim($createform)); ?>newsletter" target="_blank">Add a Newsletter Form</a></li>
                        ...
                        foreach ($cUs_json->data as $oForms => $oForm) {
                            ...
                            if ( cUsNL_allowedFormType($oForm->form_type) ) {
                                ...
                                if( !empty($default_form_key) && !isset($formSettings['updated']) && $cus_version === 'tab' ){
                                    ...
                                    update_option('cUsNL_settings_form_'.$oForm->form_id, $formSettings);
                                    $formSettings =  get_option('cUsNL_settings_form_'.$oForm->form_id);

                                    update_option('cUsNL_settings_form_key_def', $default_form_key);
                                ...
                                <form name="cus_form_<?php echo $oForm->form_id; ?>" id="cus_form_<?php echo $oForm->form_id; ?>">
                                            ...
                                            <div class="col-sm-12">
                                                <div class="white-menu">
                                                    ...
                                                    <ul class="nav nav-pills">
                                                        <li class="active"><a href="<?php echo cUsNL_CRED_URL; ?>&confirmed=1&redir_url=<?php echo urlencode(trim(cUsNL_PARTNER_URL . '/'.$partnerID . '/en/forms/gt/'.$oForm->form_id.'/formSettings/generalSettings')); ?>" target="_blank" title="Opens ContactUs admin panel in new window." class="tooltips">General Settings</a></li>
                                                        <li class="dropdown">
                                                            ...
                                                            <ul class="dropdown-menu" role="menu" title="Opens ContactUs admin panel in new window." class="tooltips">
                                                                <li><a href="<?php echo cUsNL_CRED_URL; ?>&confirmed=1&redir_url=<?php echo urlencode(trim($default_deep_link)); ?>%26expand=4" target="_blank" title="Opens ContactUs admin panel in new window" class="tooltips" data-placement="right">Edit Form Design</a></li>
                                                                <li class="divider"></li>
                                                                <li><a href="<?php echo cUsNL_CRED_URL; ?>&confirmed=1&redir_url=<?php echo urlencode(trim($default_deep_link)); ?>%26expand=5" target="_blank" title="Opens ContactUs admin panel in new window" class="tooltips" data-placement="right">Edit Tab Design</a></li>
                                                            </ul>
                                                        </li>
                                                        <?php if ($oForm->form_type == 'contact_us') { ?><li class="active"><a href="<?php echo cUsNL_CRED_URL; ?>&confirmed=1&redir_url=<?php echo urlencode(trim($default_deep_link)); ?>%26expand=14%26newTemplate=genericTemplate1" target="_blank" title="Opens ContactUs admin panel in new window" class="tooltips">Fields</a></li><?php } ?>
                                                        <li class="active"><a href="<?php echo cUsNL_CRED_URL; ?>&confirmed=1&redir_url=<?php echo urlencode(cUsNL_PARTNER_URL . '/'.$partnerID . '/en/forms/gt/'.$oForm->form_id.'/formTriggers/'); ?>" target="_blank" title="Opens ContactUs admin panel in new window." class="tooltips">Form Triggers</a></li>
                                                        <li class="active"><a href="<?php echo cUsNL_CRED_URL; ?>&confirmed=1&redir_url=<?php echo urlencode(trim($default_deep_link)); ?>%26expand=103" target="_blank" title="Opens ContactUs admin panel in new window." class="tooltips">Integrations</a></li>
                                                        <li class="active"><a href="<?php echo cUsNL_CRED_URL; ?>&confirmed=1&redir_url=<?php echo urlencode(cUsNL_PARTNER_URL . '/'.$partnerID . '/en/forms/gt/'.$oForm->form_id.'/formSubmissionSettings/formNotifications/'); ?>" target="_blank" title="Opens ContactUs admin panel in new window." class="tooltips">Notifications</a></li>
                                                    </ul>
                                                </div>
                                            </div>
                                        </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <div class="scode-box">
                                                            ...
                                                            <p>
                                                            <h5> Tab Form </h5>
                                                            [show-newsletter-form formkey=”<?php echo $oForm->form_key; ?>" version=”tab"]
                                                            <h5> Inline Form </h5>
                                                            [show-newsletter-form formkey=”<?php echo $oForm->form_key; ?>" version="inline"]
                                                            </p>
                                                        </div>
                                                    </div>
                                    ...
                                    <input type="hidden" name="action" value="cUsNL_setDefaulFormKeyByID">
                                ...
                                //echo $userJScode = '<script type="text/javascript" src="' . cUsNL_ENV_URL . $oForm->form_key . '/contactus.js"></script>';
    ...
    cUsNL_myjq(document).ready(function($) {
        ...
        try {
            $(".preview-form").on('click', function(){
                ...
                //console.log(formKey);
                var form_Preview = '<h2>Form Preview</h2><br/><iframe id="formPreview" width="100%" style="min-height:540px;max-height:800px;" src="<?php echo cUsNL_ENV_URL;?>/'+ formKey+'/">';
