...
<table class="table table-hover">
    ...
    <tbody>
        ...
        <tr>
            <?php
            $homeSettings    = get_option('cUsNL_HOME_settings');
            ?>
            <form name="page-form-home" id="page-form-home">
                ...
                <input type="hidden" name="action" value="cUsNL_setPageSettingsHome">
            </form>
        </tr>
        <!-- FORM TR END -->
    ...
    <?php
        ...
        if (is_array($mypages)) {
            foreach ($mypages as $page) {
                $pageSettings = get_post_meta($page->ID, 'cUsNL_FormByPage_settings', true);
                ?>
                ...
                <tr class="form_placement_item">
                    ...
                    <form name="page-form-<?php echo $page->ID; ?>" id="page-form-<?php echo $page->ID; ?>">
                        ...
                        <td>
                            ...
                            <select class="form-control form_key_byPage" name="form-key" data-pageid="<?php echo $page->ID; ?>">
                                ...
                                if ($cUsNL_API_getFormKeys) {
                                    ...
                                    update_option('cUsNL_settings_form_thumbs', $aryFormThumbs );//UPDATE FORM SETTINGS
                                }
                                ?>
                            </select>
                            <script>
                        ...
                        <input type="hidden" name="action" value="cUsNL_setPageSettings">
...
<script>
    ...
    cUsNL_myjq(document).ready(function($) {
        ...
        $('.form_key_byPage').change(function(){
            ...
            var oFormData = 'action=cUsNL_setFormKeyByPage';
